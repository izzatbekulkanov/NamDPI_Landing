(function($) {
    ...
    // Btn Hover
    if ($(".tolak-btn").length) {
        $('.tolak-btn').on('mouseenter', function(e) {
    ...
    if ($(".tolak-btn-rtl").length) {
        $('.tolak-btn-rtl').on('mouseenter', function(e) {
            var parentOffset = $(this).offset(),
    ...
    if ($(".service-details__sidebar__nav").length) {
        // dynamic current class
        let mainNavUL = $(".service-details__sidebar__nav");
        dynamicCurrentMenuClass(mainNavUL);
    }
    ...
    // Sidebar
    if ($(".main-header__toggler, .main-header-four__toggler, .sidebar-one__overlay, .sidebar-one__close").length) {
        $(".main-header__toggler, .main-header-four__toggler, .sidebar-one__overlay, .sidebar-one__close").on("click", function(e) {
            e.preventDefault();
    ...
    function thmOwlInit() {
        ...
        let tolakowlCarouselNav = $(".tolak-owl__carousel--custom-nav");
    ...
    function tolak_stretch() {
        var i = $(window).width();
        $(".row .tolak-stretch-element-inside-column").each(function() {
            var $this = $(this),
